    ...
    return (
        <Wrapper>
            <div className="btn-container">
                <button type='button' className={ grid_view ? 'active' : undefined } onClick={set_gridview}>
                    <BsFillGridFill/>
                </button>
                <button type='button' className={ !grid_view ? 'active' :undefined } onClick={set_listview}>
                    <BsList/>
                </button>
            </div>
